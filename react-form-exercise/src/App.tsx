...
const App = () => {
  ...
  const [displayUserData, setDisplayUserData] = useState<boolean>(false)
    ...
    <div>
      ...
      <form>
        ...
        <div>
          ...
          <input type="text" id="lastname" onChange={handleChange} name="lastname" value={formData.lastname} />
        </div>
        <div>
      ...
      <button onClick={() => setDisplayUserData(!displayUserData)}>Display User</button>
